...
class App extends React.Component {
    constructor(props) {
        ...
        this.classListF = ['favorites', 'habits']
    ...
    componentDidMount() {
        window.onscroll = () => {
            ...
            if (window.pageYOffset > 1250) {
                ...
                //document.body.style.backgroundImage = 'linear-gradient(90deg, #FCC76F, #F240A2)'
                //document.body.classList.add('bodyHab');
            }
        };
    }
        ...
        return (
            <div className="appContainer">
                {this.classListF.map(ClassNN => {
                    /*if (ClassNN === classN) {
                        document.body.classList.add('bodyHabits');
                    }*/
...
class Navbar extends React.Component {
    render() {
        const classList = ['navMainContainer favorites', 'navMainContainer habits']
